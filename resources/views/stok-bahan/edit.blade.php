{{-- resources/views/stok-bahan/edit.blade.php --}}
@extends('layouts.app')
...
@section('content')
    ...
    {{-- Modal Pop-up untuk Form Edit Bahan --}}
    <div id="modalEditBahan" style="
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
    ...
    ">
        ...
        ">
            ...
            <h3 style="margin-top: 0; border-bottom: 1px solid #eee; padding-bottom: 15px; margin-bottom: 10px; color: #333;">
                ✍️ Edit Bahan: {{ $bahan->nama }}
            </h3>
            ...
            <form action="{{ route('stok.bahan.update', $bahan->id) }}" method="POST">
                ...
                <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                    <div style="flex: 2;">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control" value="{{ old('nama', $bahan->nama) }}" placeholder="Contoh: Tepung Terigu" required>
                    </div>
                    <div style="flex: 1;">
                ...
                <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="satuan" id="satuan" class="form-control" value="{{ old('satuan', $bahan->satuan) }}" placeholder="Kg/Liter/Butir" required>
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <input type="number" name="harga_satuan" id="harga_satuan" class="form-control" step="0.01" value="{{ old('harga_satuan', $bahan->harga_satuan) }}" required>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <input type="text" name="lokasi" id="lokasi" class="form-control" value="{{ old('lokasi', $bahan->lokasi) }}" placeholder="Contoh: Rak B-1 / Freezer">
                </div>
                ...
                <div style="text-align: right; border-top: 1px solid #eee; padding-top: 15px;">
                    ...
                    <button type="submit" style="
                        padding: 10px 20px;
                        background: #007bff; /* Warna biru untuk Update */
                        color: white;
                        border: none;
                        border-radius: 8px;
                        cursor: pointer;
    ...
    {{-- Styling untuk Form Control dan Animasi --}}
    <style>
        /* Menggunakan style yang sama untuk form-control */
        .form-control {
            width: 100%;
            padding: 10px;
